...
export default function Hero() {
  ...
  return (
    <header
      id="home"
      ref={revealRef}
      className="relative min-h-[80vh] lg:min-h-screen flex items-center px-6 sm:px-8 lg:px-12 pt-12 lg:pt-0 overflow-hidden reveal"
      style={{
        background:
    ...
    >
      <div className="relative z-10 max-w-[65ch]">
        {/* Sección numerada editorial */}
        <span
          className="font-mono text-[13px] text-primary tracking-[0.15em] uppercase mb-6 block"
          data-reveal-delay="0"
        >
          —&nbsp; Intro
        </span>

        {/* Nombre — tipografía display enorme */}
        <h1 className="mb-6" data-reveal-delay="100">
          <span
        ...
        {/* Rol en mono */}
        <p
          className="font-mono text-base sm:text-lg text-surface-500 mb-6"
          data-reveal-delay="200"
        >
          {'< Full-Stack Developer />'}
        </p>

        {/* Descripción editorial — ancho controlado ~65ch */}
        <p
          className="text-surface-400 text-base sm:text-lg leading-relaxed mb-10"
          style={{ maxWidth: '65ch' }}
        ...
        >
          <a
            href="#contact"
            className="group relative inline-flex items-center gap-2.5 px-7 py-3.5 bg-primary text-black font-bold text-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-button-glow hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        >
          <div>
            ...
            <span className="text-surface-700 ml-2">años exp.</span>
          </div>
