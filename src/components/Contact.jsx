...
/* ============================================================
   ...
   ============================================================ */
const WEB3FORMS_ACCESS_KEY = '6f3fb6bf-93f0-42e4-8926-f3a3c6a3b2c5'
const EMAIL = 'TODO'        /* ← Reemplazar con email real antes de producción */
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 max-w-5xl mx-auto">
        ...
        <div className="space-y-8 reveal" data-reveal-delay="200">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <SocialLink href="https://linkedin.com/in/edisonm22" label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
