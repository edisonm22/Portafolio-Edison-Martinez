                ...
                return (
                  <li key={item.id}>
                    ...
                    >
                      ...
                      />
                      <span
                        className={`font-display text-sm tracking-wide transition-all duration-300 ${
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="GitHub"
              className="w-9 h-9 flex items-center justify-center rounded-lg bg-surface-900 border border-surface-800 text-surface-600 transition-all duration-300 hover:bg-primary/10 hover:border-primary/30 hover:text-primary"
            >
