      ...
      <aside className="hidden lg:flex fixed top-0 left-0 z-30 w-72 h-screen flex-col justify-between px-8 py-10 border-r border-white/5 bg-surface-950/70 backdrop-blur-2xl">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <span className="block text-[11px] font-mono text-surface-400 mt-1 tracking-[0.15em] uppercase">
                    ...
                    <a
                      ...
                      className={`group flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-300 ${
                        isActive
                          ...
                          : 'text-surface-400 hover:text-surface-300 hover:bg-surface-900/50'
                      }`}
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            aria-label="GitHub"
            className="w-8 h-8 flex items-center justify-center rounded-lg bg-surface-900/50 border border-surface-800/50 text-surface-400 transition-all duration-300 hover:bg-primary/10 hover:border-primary/30 hover:text-primary"
              >
          ...
          <div className="flex flex-col h-full pt-24 px-8 pb-8">
            ...
            <div className="flex gap-3 pt-6 border-t border-surface-800">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-surface-800 border border-surface-700 text-surface-400 transition-all hover:bg-primary/10 hover:border-primary/30 hover:text-primary"
              >
